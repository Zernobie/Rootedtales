...
function TriviaGame({ characters, onBack, onScore, gameHeader, gameControls, isPaused, onNextGame }: any) {
  ...
  // Guard: Don't generate questions if no characters
...
function WordPuzzleGame({ characters, onBack, onScore, gameHeader, gameControls, isPaused, onNextGame }: any) {
  // Guard: Don't proceed if no characters
  if (!characters || characters.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 p-6 pb-24 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600">Loading characters...</p>
        </div>
      </div>
